...
/*   Updated: 2021/11/03 14:09:10 by rcappend      ########   odam.nl         */
/*                                                                            */
/* ************************************************************************** */
...
void	move_left_right(t_player *player, const int key, const t_map map)
{
	...
	if (key == KEY_D)
	{
		if (xy_to_map(player->x + player->plane_x * (move_speed * 1.5), \
						player->y, map) != '1')
